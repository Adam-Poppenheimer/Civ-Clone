...
namespace Assets.Tests.Simulation.Units {
    ...
    public class GameUnitTests : ZenjectUnitTestFixture {
        ...
        public void CommonInstall() {
            ...
            Container.Bind<IPromotionParser>().FromInstance(new Mock<IPromotionParser>().Object);
        ...
        public void OnBeginDrag_SignalFired() {
            ...
            Container.Resolve<UnitSignals>().BeginDrag.Subscribe(delegate(Tuple<IUnit, PointerEventData> dataTuple) {
        ...
        public void OnDrag_SignalFired() {
            ...
            Container.Resolve<UnitSignals>().Drag.Subscribe(delegate(Tuple<IUnit, PointerEventData> dataTuple) {
        ...
        public void OnEndDrag_SignalFired() {
            ...
            Container.Resolve<UnitSignals>().EndDrag.Subscribe(delegate(Tuple<IUnit, PointerEventData> dataTuple) {
