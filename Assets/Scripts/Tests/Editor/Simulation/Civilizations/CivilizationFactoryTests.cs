...
namespace Assets.Tests.Simulation.Civilizations {
    ...
    public class CivilizationFactoryTests : ZenjectUnitTestFixture {
        ...
        public void CommonInstall() {
            Container.Bind<IPossessionRelationship<ICivilization, ICity>>().FromInstance(new Mock<IPossessionRelationship<ICivilization, ICity>>().Object);
            Container.Bind<ICivilizationYieldLogic>                      ().FromInstance(new Mock<ICivilizationYieldLogic>                      ().Object);
            Container.Bind<ITechCanon>                                   ().FromInstance(new Mock<ITechCanon>                                   ().Object);
            Container.Bind<IGreatPersonCanon>                            ().FromInstance(new Mock<IGreatPersonCanon>                            ().Object);
            Container.Bind<IGreatPersonFactory>                          ().FromInstance(new Mock<IGreatPersonFactory>                          ().Object);
            Container.Bind<IGoldenAgeCanon>                              ().FromInstance(new Mock<IGoldenAgeCanon>                              ().Object);
            Container.Bind<ICivilizationHappinessLogic>                  ().FromInstance(new Mock<ICivilizationHappinessLogic>                  ().Object);
            Container.Bind<ICivilizationConfig>                          ().FromInstance(new Mock<ICivilizationConfig>                          ().Object);
            Container.Bind<ICivModifiers>                                ().FromInstance(new Mock<ICivModifiers>                                ().Object);
