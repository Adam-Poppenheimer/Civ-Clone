...
namespace Assets.Simulation.Units {
    ...
    public class GameUnit : MonoBehaviour, IUnit, IPointerClickHandler, IBeginDragHandler,
            ...
            set {
                if(_experience != value) {
                    ...
                    if(experienceGained > 0) {
                        Signals.GainedExperience.OnNext(new System.Tuple<IUnit, int>(this, experienceGained));
                    }
                }
            }
        }
        ...
        public void OnBeginDrag(PointerEventData eventData) {
            Signals.BeginDrag.OnNext(new System.Tuple<IUnit, PointerEventData>(this, eventData));
        }

        public void OnDrag(PointerEventData eventData) {
            Signals.Drag.OnNext(new System.Tuple<IUnit, PointerEventData>(this, eventData));
        }

        public void OnEndDrag(PointerEventData eventData) {
            Signals.EndDrag.OnNext(new System.Tuple<IUnit, PointerEventData>(this, eventData));
        }
