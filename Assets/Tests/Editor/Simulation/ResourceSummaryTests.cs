...
namespace Assets.Tests.Simulation {
    ...
    public class ResourceSummaryTests : ZenjectUnitTestFixture{
        ...
        public void AdditionOperator_AddsComponents() {
            var summaryOne   = new ResourceSummary(food: 3, production: 2, gold: 1);
            var summaryTwo   = new ResourceSummary(production: 5, gold: 1, culture: 6);
            var summaryThree = new ResourceSummary(food: 9, gold: 17, culture: 12);

            var copyOfOne   = new ResourceSummary(summaryOne);
            var copyOfTwo   = new ResourceSummary(summaryTwo);
            var copyOfThree = new ResourceSummary(summaryThree);
        ...
        public void MultiplicationOperatorInt_MultipliesComponentsByCoefficient() {
            var summary = new ResourceSummary(food: 3, production: 2, gold: 0);
        ...
        public void MultiplicationOperatorFloat_MultipliesComponentsByCoefficientAndRounds() {
            var summary = new ResourceSummary(food: 1, production: 1, gold: 1);
            var copyOfSummary = new ResourceSummary(summary);
        ...
        [Test(Description = "The Total property should return the sum of all resources in the ResourceSummary")]
        public void Total_ReturnsSumOfAllResources() {
            var summary = new ResourceSummary(food: 4, production: 9, gold: -3, culture: 0);
