...
namespace Assets.UI.GameMap {
    ...
    public class TileHoverDisplay : MonoBehaviour {
        ...
        public void InjectDependencies(
            ...
            IMapTileSignalLogic signalLogic, IResourceGenerationLogic generationLogic,
        ...
        private void OnBeginHoverFired(IMapTile hoveredTile) {
        ...
        private void OnEndHoverFired(IMapTile unhoveredTile) {
